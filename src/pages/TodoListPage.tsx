...
export default function TodoListPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-todo-gray-700">
      <div className="p-8 rounded-lg w-full max-w-2xl bg-todo-gray-500">
        {/* 헤더 */}
        <h1 className="text-todo-title font-bold mb-6 text-todo-blue">🚀 todo</h1>
        ...
        <div className="flex gap-2 mb-6">
          ...
          <button
            ...
            className="px-4 py-3 rounded-todo transition-colors font-bold text-todo-body bg-todo-blue-dark text-todo-gray-100 hover:bg-todo-blue"
          >
            Criar
          </button>
        </div>
